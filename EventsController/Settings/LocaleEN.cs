    ...
    public class LocaleEN : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                //Lighting Strikes
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.LightningStrikeOccurenceToggle)), "Lightning Strikes" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.LightningStrikeOccurenceToggle)), "Toggle whether lightning strikes can occur in your city. When enabled, lightning strikes will not happen" },
                ...
                //Tornado
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.TornadoOccurenceToggle)), "Tornadoes" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.TornadoOccurenceToggle)), "Toggle whether tornadoes can form in your city, when enabled tornadoes will happen not happen" },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.BuildingCollapseOccurenceToggle)), "Building Collapses" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.BuildingCollapseOccurenceToggle)), "Toggle whether buildings can collapse, when enabled buildings should not collapse" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.BuildingFireToggle)), "Building Fires" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.BuildingFireToggle)), "Toggle whether building can be on fire, Enabled means building fires can happen." },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.ForestFireToggle)), "Toggle whether forest fires can happen, Enabled means forest fires can happen." },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.EnableWeatherEffectsOnFires)), "Weather based fires" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.EnableWeatherEffectsOnFires)), "When enabled, forest fire behavior is influenced by weather conditions. Hot, dry periods increase fire risk and intensity, while rain and snow reduce it. Creating more realistic and dynamic fire events." },
                
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.RobberyOccurenceToggle)), "Robberies" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.RobberyOccurenceToggle)), "Toggle whether robberies can haapen." },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.LCAAccidentOccurenceToggle)), "Traffic accidents" },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.LCAFireStartProbabilityToggle)), "Traffic accident fires" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.LCAFireStartProbabilityToggle)), "Toggle whether vehicle accidents can cause fires." },
                
                
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.HsOccurenceToggle)), "Hail Storms" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.HsOccurenceToggle)), "Toggle whether hail storms can occur in your city. when enabled hails storms should not happen" },
